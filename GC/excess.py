# Hack for using map estimator when nuisance fit is included
...
from gammapy.estimators.core import Estimator
from gammapy.estimators.utils import estimate_exposure_reco_energy
from gammapy.estimators.map.core import FluxMaps
