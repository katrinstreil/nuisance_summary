...
from gammapy.modeling import Parameters  # , Covariance
...
name = "4-Fitting_nuisance_and_model_parameters"
sys.path.append(
    f"/home/hpc/caph/mppi045h/3D_analysis/N_parameters_in_L/syserror_3d_bkgmodel/{name}"
)

# definitons

source = "Crab"
path2 = "HESS_3Dbkg_syserror/2-error_in_dataset"
path = "/home/vault/caph/mppi062h/repositories/" + path2
temp = "syserror_3d_bkgmodel/2-source_dataset"
path_local_repo = "/home/hpc/caph/mppi045h/3D_analysis/N_parameters_in_L/" + temp
...
added = "_008_624"
dataset_N = MapDatasetNuisance.read(
    f"{path_local_repo}/{source}/nui_dataset{added}.fits"
)
...
def plot_residual(dataset, max_=None):
    ...
    if max_ is None:
        ...
        vmax = max_
    res_standard.slice_by_idx(dict(energy=slice(i_start, i_end))).plot_grid(
        add_cbar=1, vmax=vmax, vmin=-vmax, cmap="coolwarm"
    )
    return res_standard
