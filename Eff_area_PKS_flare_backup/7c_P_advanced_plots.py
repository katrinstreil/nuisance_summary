...
# %%
plt.plot(c['x'], np.array(c['y'])*1e-12, '.-', label='Standard 1$\sigma$', color = 'red')
plt.plot(c39['x'], np.array(c39['y'])*1e-12, '.-', label='Standard 1$\sigma$', color = 'darkred')
plt.plot(c_N['x'], np.array(c_N['y'])*1e-12, '.-', label='NUI 1$\sigma$', color = 'green')
